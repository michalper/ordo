...
class MassDisable extends AbstractLeadRoutingRuleAction implements HttpPostActionInterface
{
    ...
    public function execute()
    {
        ...
        foreach ($collection as $leadRoutingRule) {
            ...
            $leadRoutingRule->setEnabled(false);
            $this->leadRoutingRuleResource->save($leadRoutingRule);
            $count++;
        }

        $this->messageManager->addSuccessMessage(__('A total of %1 lead routing rule(s) have been disabled.', $count));
