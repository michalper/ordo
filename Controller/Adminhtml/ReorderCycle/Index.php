...
{
    // Gates on its own dedicated acl.xml resource (reorder_cycle) rather than the broader
    // campaigns resource, so access to this diagnostic view can be granted independently of
