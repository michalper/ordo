...
- **Buy X Get Y free** — already 100% native Magento (`SalesRule` "Buy X Get Y" discount action); needs only a human-friendly config screen with a live calculator (no admin UI built yet — see Phase 4), not new backend logic. **Still open.**
