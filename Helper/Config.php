...
class Config
{
    ...
    private const string XML_PATH_BROWSE_ABANDONMENT_DELAY_MINUTES
        = 'ordo_automation/browse_abandonment/delay_minutes';
    ...
    {
        return $this->scopeConfig->isSetFlag(
            self::XML_PATH_BROWSE_ABANDONMENT_ENABLED,
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    }

    public function getBrowseAbandonmentDelayMinutes(?int $storeId = null): int
    {
        return $this->intConfig(self::XML_PATH_BROWSE_ABANDONMENT_DELAY_MINUTES, 60, $storeId);
    }
    ...
    public function isReviewRequestEnabled(?int $storeId = null): bool
    {
        return $this->scopeConfig->isSetFlag(
            self::XML_PATH_REVIEW_REQUEST_ENABLED,
            ScopeInterface::SCOPE_STORE,
            $storeId
        );
    }
