...
class PushSendRetry extends AbstractDb
{
    protected function _construct(): void
    {
        $this->_init('ordo_push_send_retry', 'entity_id');
    }

    /**
     * Claims a due row for this retry attempt as a single conditional UPDATE - same atomic-claim
     * pattern as ResourceModel\MessageSendRetry::claim(): bumping next_retry_at forward
     ...
     */
    public function claim(PushSendRetryModel $model, string $now, string $tentativeNextRetryAt): bool
    {
