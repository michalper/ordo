...
**Status: every row below is ✅ except one 🔴 (see §10) and seventeen ⬜ (the frequency-cap
...
Template Test Send rows in §16, the two Cron Run Log rows in §17, and the four Product feed rows
in §18 — all unit-tested but no
