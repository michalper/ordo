...
the four Product feed rows in §18, and the two Setup Guide rows in §19 — all unit-tested but no
...
## 19. Setup Guide (`Block/Adminhtml/Setup/SetupWizardViewModel.php`, `Controller/Adminhtml/Setup/`)
