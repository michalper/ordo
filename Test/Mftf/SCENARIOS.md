...
Template Test Send rows in §16, the two Cron Run Log rows in §17, the four Product feed rows in
§18, and the three Admin Action Log rows in §19 — all unit-tested but no
