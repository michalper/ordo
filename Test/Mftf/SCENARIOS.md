...
**Status: every row below is ✅ except one 🔴 (see §10) and eleven ⬜ (the frequency-cap structural
case and the Campaign export row in §1d, the Order Approvals grid in §6, the Segment Overlap page
