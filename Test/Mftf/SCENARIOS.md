...
`RetryFailedCampaignActions` row in §11, the Approval rate-limit row in §6, the Segment Overlap
page and Segment export row in §2, the WhatsApp Template Body Text preview panel in §15, the two
