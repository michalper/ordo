...
class AddCustomerTimezoneAttributeTest extends TestCase
{
    public function testApplyAddsAttribute(): void
    {
        ...
        $patch = new AddCustomerTimezoneAttribute($moduleDataSetup, $customerSetupFactory);
        $patch->apply();
    }

    public function testGetDependenciesAndAliasesAreEmpty(): void
    {
        self::assertSame([], AddCustomerTimezoneAttribute::getDependencies());
