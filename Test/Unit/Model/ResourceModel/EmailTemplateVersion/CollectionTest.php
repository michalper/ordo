...
namespace Ordo\Automation\Test\Unit\Model\ResourceModel\EmailTemplateVersion;

use Ordo\Automation\Model\ResourceModel\EmailTemplateVersion\Collection;
...
{
    public function testAddTemplateFilterIsFluent(): void
    {
        ...
        self::assertSame($collection, $collection->addTemplateFilter(7));
    }
}
