...
use Ordo\Automation\Block\Adminhtml\LeadRoutingRule\Edit\DeleteButton;
...
class DeleteButtonTest extends TestCase
{
    ...
    public function testGetButtonDataIncludesDeleteUrlWhenEntityIdPresent(): void
    {
        ...
        $urlBuilder->method('getUrl')
            ->willReturnMap([['*/*/delete', ['entity_id' => 5], 'https://example.com/admin/ordo/leadroutingrule/delete/entity_id/5/']]);
