...
use Ordo\Automation\Block\Adminhtml\Campaign\Edit\BackButton;
...
class BackButtonTest extends TestCase
{
    ...
    public function testGetButtonDataIncludesBackUrl(): void
    {
        ...
        $urlBuilder->method('getUrl')->willReturnMap([['*/*/', [], 'https://example.com/admin/ordo/campaign/']]);
        ...
        self::assertStringContainsString('https://example.com/admin/ordo/campaign/', $data['on_click']);
    }
}
