...
use Ordo\Automation\Controller\Adminhtml\Segment\Overlap;
use Ordo\Automation\Test\Unit\Controller\AbstractAdminActionTestCase;
use PHPUnit\Framework\Attributes\AllowMockObjectsWithoutExpectations;

class OverlapTest extends AbstractAdminActionTestCase
{
    ...
    public function testExecuteBuildsResultPage(): void
    {
        ...
        $title->expects(self::once())->method('prepend')->with(__('Segment Overlap'));
        ...
        $controller = new Overlap($context, $resultPageFactory);
