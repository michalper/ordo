...
namespace Ordo\Automation\Test\Unit\Controller\Adminhtml\ConversationMessage;

use Magento\Framework\View\Page\Config as PageConfig;
use Magento\Framework\View\Page\Title;
use Magento\Backend\Model\View\Result\Page;
use Magento\Framework\View\Result\PageFactory;
use Ordo\Automation\Controller\Adminhtml\ConversationMessage\Index;
...
class IndexTest extends AbstractAdminActionTestCase
{
    ...
    public function testExecuteBuildsResultPage(): void
    {
        ...
        $title->expects(self::once())->method('prepend')->with(__('Conversations'));
        ...
        $resultPage->expects(self::once())->method('setActiveMenu')
            ->with('Ordo_Automation::conversation_message')->willReturnSelf();
