...
use Ordo\Automation\Controller\Adminhtml\PushSubscription\Index;
...
class IndexTest extends AbstractAdminActionTestCase
{
    ...
    public function testExecuteBuildsResultPage(): void
    {
        ...
        $title->expects(self::once())->method('prepend')->with(__('Push Subscriptions'));
        ...
        $resultPage->expects(self::once())
            ...
            ->with('Ordo_Automation::push_subscriptions')
            ->willReturnSelf();
    ...
    public function testUsesPushSubscriptionsAclResource(): void
    {
        self::assertSame('Ordo_Automation::push_subscriptions', Index::ADMIN_RESOURCE);
    }
}
