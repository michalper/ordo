...
namespace Ordo\Automation\Test\Unit\Controller\Adminhtml\OrderApproval;

use Magento\Framework\View\Page\Config as PageConfig;
use Magento\Framework\View\Page\Title;
use Magento\Backend\Model\View\Result\Page;
use Magento\Framework\View\Result\PageFactory;
use Ordo\Automation\Controller\Adminhtml\OrderApproval\Index;
...
class IndexTest extends AbstractAdminActionTestCase
{
    ...
    public function testExecuteBuildsResultPage(): void
    {
        ...
        $title->expects(self::once())->method('prepend')->with(__('Order Approvals'));
