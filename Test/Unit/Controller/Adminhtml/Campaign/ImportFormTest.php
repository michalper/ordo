...
use Ordo\Automation\Controller\Adminhtml\Campaign\ImportForm;
use Ordo\Automation\Test\Unit\Controller\AbstractAdminActionTestCase;
use PHPUnit\Framework\Attributes\AllowMockObjectsWithoutExpectations;

class ImportFormTest extends AbstractAdminActionTestCase
{
    ...
    public function testExecuteBuildsResultPage(): void
    {
        ...
        $title->expects(self::once())->method('prepend')->with(__('Import Campaign'));
        ...
        $controller = new ImportForm($context, $resultPageFactory);
