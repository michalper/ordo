...
use Ordo\Automation\Controller\Referral\AbstractReferralAction;
use PHPUnit\Framework\Attributes\AllowMockObjectsWithoutExpectations;
use PHPUnit\Framework\TestCase;

class AbstractReferralActionTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // ActionFlag::get()/set() are exercised for real (not mocked) — same reasoning as
        // AbstractOfferActionTest.
        $this->actionFlag = new ActionFlag($this->request);

        $this->response = $this->createStub(ResponseInterface::class);
    }

    private function makeController(): AbstractReferralAction
    {
        ...
        return new class ($context, $this->customerSession, $this->customerUrl) extends AbstractReferralAction {
